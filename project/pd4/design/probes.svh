...
`define PROBE_R_WRITE_ENABLE      r_wen
`define PROBE_R_WRITE_DESTINATION r_wdst
`define PROBE_R_WRITE_DATA        r_wdata
`define PROBE_R_READ_RS1          r_rs1
`define PROBE_R_READ_RS2          r_rs2
`define PROBE_R_READ_RS1_DATA     r_rs1_data
`define PROBE_R_READ_RS2_DATA     r_rs2_data
...
`define PROBE_M_SIZE_ENCODED      m_size
`define PROBE_M_DATA              m_data

`define PROBE_W_PC                w_pc
`define PROBE_W_ENABLE            w_en
`define PROBE_W_DESTINATION       w_dst
